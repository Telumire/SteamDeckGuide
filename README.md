...
A neat way to do that is to use the vscode web editor. Simply press `.` to open the editor. Unfold the "tiddlers" folder, then edit the tiddlers or create your own. To push your changes, go to the Source Control icon, set a message and press the checkmark button.
